...
void main() {
    ...
    if (gl_InvocationID == 0) {
        ...
        /*
        // subdivisions
        gl_TessLevelOuter[0] = 3.0; // subdivisions along v1,v2 edge
        gl_TessLevelOuter[1] = 3.0; // subdivisions along v2,v0 edge
        gl_TessLevelOuter[2] = 3.0; // subdivisions along v0,v1 edge
